...
export function LoopEditorToolbar({
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-800/30 border border-gray-700 flex-wrap">
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="flex bg-gray-800 rounded p-0.5 border border-gray-700">
          <button
            ...
            onClick={() => dispatch({ type: 'SET_BAR_COUNT', payload: 8 })}
          >
            8 Bars
          </button>
          <button
            ...
            onClick={() => dispatch({ type: 'SET_BAR_COUNT', payload: 16 })}
          >
            16 Bars
          </button>
        </div>
      ...
      <button
        className="px-2 py-1 text-xs rounded bg-amber-600/20 text-amber-400 border border-amber-600/30 hover:bg-amber-600/30 transition-colors"
        onClick={() => dispatch({ type: 'GENERATE_TEST_PATTERN' })}
      >
        Generate Test Pattern
      </button>
